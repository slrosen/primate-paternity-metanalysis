...
│   │   ├── paternity_table.xlsx      # Primary paternity dataset (Excel)
│   │   ├── paternity_table.csv       # Cleaned paternity dataset (generated by Rmd)
│   │   ├── morphology_lifehistory_data.xlsx  # Morphological and life history trait data
│   │   └── seasonality_data.xlsx     # Reproductive seasonality data
...
└── literature/
    ...
    └── paternity-table-bibliography.pdf # Rendered source bibliography
```
